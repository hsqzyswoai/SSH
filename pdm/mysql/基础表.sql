...
CREATE TABLE tbSysImg (
  ...
  sCss varchar(128) DEFAULT NULL,
  sCssFilePath varchar(256) DEFAULT NULL,
  sImgPath varchar(256) NOT NULL,
  sRemark varchar(256) DEFAULT NULL,
  sStandard varchar(64) DEFAULT NULL,
  sClass varchar(128) DEFAULT NULL,
  PRIMARY KEY (iId)
) ENGINE=InnoDB DEFAULT CHARSET=utf8
go
